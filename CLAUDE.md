...
This project is indexed by GitNexus as **gsd-autonomous-dev** (876 symbols, 1685 relationships, 51 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
