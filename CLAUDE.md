...
This project is indexed by GitNexus as **gsd-autonomous-dev** (830 symbols, 1632 relationships, 47 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
