...
```powershell
# Install (runs 15 scripts in dependency order)
...
The repository contains 22 scripts: 1 master installer + 1 pre-flight + 15 core + 4 standalone utilities + 1 bug fix patch. Run `install-gsd-all.ps1` to install everything.
