...
This project is indexed by GitNexus as **gsd-autonomous-dev** (984 symbols, 1962 relationships, 59 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
