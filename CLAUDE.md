...
This project is indexed by GitNexus as **gsd-autonomous-dev** (1072 symbols, 2122 relationships, 67 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
