...
This project is indexed by GitNexus as **gsd-autonomous-dev** (1005 symbols, 1985 relationships, 61 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
